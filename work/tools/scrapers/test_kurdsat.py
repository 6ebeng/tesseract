#!/usr/bin/env python3
"""
Test Kurdsat Scraper with V4.0 Config
Tests the generic scraper against kurdsat.yaml config
"""
...
def test_kurdsat():
    """Test Kurdsat scraper with all categories"""
    print("=" * 80)
    print("🧪 TESTING KURDSAT TV SCRAPER (V4.0 Config)")
    print("=" * 80)
    print()
    ...
    # Test categories
    categories = ['news', 'health', 'science', 'technology', 'opinion']
    ...
    for category in categories:
        ...
        try:
            sentences = scraper.scrape_category('kurdsat', category, max_articles=3)
...
def test_kurdsat_quick():
    """Quick test - just news category with 2 articles"""
    print("=" * 80)
    print("🧪 QUICK TEST: KURDSAT NEWS (2 articles)")
    print("=" * 80)
    print()
    ...
    try:
        ...
        scraper = GenericScraper(str(config_dir))
        print("\n🔍 Starting scraping...")
        sentences = scraper.scrape_category('kurdsat', 'news', max_articles=2)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '--quick':
        success = test_kurdsat_quick()
    else:
        success = test_kurdsat()
