#!/usr/bin/env python3
"""Verify Opinion category pagination"""
...
print("=" * 70)
print("🔍 VERIFYING OPINION CATEGORY PAGINATION")
print("=" * 70)
...
try:
    ...
    for page_num in [1, 2, 3]:
        ...
        # Find articles on this page - Opinion uses different selector
        article_links = scraper.driver.find_elements(By.CSS_SELECTOR, "div.birura-page ul li a")
        ...
        for link_elem in article_links[:5]:  # Just check first 5
            try:
                ...
                if href and 'op-detail.aspx' in href:
                    articles.append({
                        'url': href,
        ...
        print(f"   Found {len(articles)} opinion articles:")
